...
class ControllerLocalisationCountry extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('localisation/country', 'user_tokens=' . $this->session->data['user_tokens'] . $url));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('localisation/country', 'user_tokens=' . $this->session->data['user_tokens'] . $url)
		);

		$data['add'] = $this->url->link('localisation/country/add', 'user_tokens=' . $this->session->data['user_tokens'] . $url);
		$data['delete'] = $this->url->link('localisation/country/delete', 'user_tokens=' . $this->session->data['user_tokens'] . $url);
		...
		foreach ($results as $result) {
			$data['countries'][] = array(
				...
				'edit'       => $this->url->link('localisation/country/edit', 'user_tokens=' . $this->session->data['user_tokens'] . '&country_id=' . $result['country_id'] . $url)
			);
		}
		...
		$data['sort_name'] = $this->url->link('localisation/country', 'user_tokens=' . $this->session->data['user_tokens'] . '&sort=name' . $url);
		$data['sort_iso_code_2'] = $this->url->link('localisation/country', 'user_tokens=' . $this->session->data['user_tokens'] . '&sort=iso_code_2' . $url);
		$data['sort_iso_code_3'] = $this->url->link('localisation/country', 'user_tokens=' . $this->session->data['user_tokens'] . '&sort=iso_code_3' . $url);
		...
		$pagination->url = $this->url->link('localisation/country', 'user_tokens=' . $this->session->data['user_tokens'] . $url . '&page={page}');
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['country_id'])) {
			$data['action'] = $this->url->link('localisation/country/add', 'user_tokens=' . $this->session->data['user_tokens'] . $url);
		} else {
			$data['action'] = $this->url->link('localisation/country/edit', 'user_tokens=' . $this->session->data['user_tokens'] . '&country_id=' . $this->request->get['country_id'] . $url);
		}

		$data['cancel'] = $this->url->link('localisation/country', 'user_tokens=' . $this->session->data['user_tokens'] . $url);
