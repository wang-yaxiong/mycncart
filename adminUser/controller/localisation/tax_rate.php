...
class ControllerLocalisationTaxRate extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('localisation/tax_rate', 'user_tokens=' . $this->session->data['user_tokens'] . $url));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('localisation/tax_rate', 'user_tokens=' . $this->session->data['user_tokens'] . $url)
		);

		$data['add'] = $this->url->link('localisation/tax_rate/add', 'user_tokens=' . $this->session->data['user_tokens'] . $url);
		$data['delete'] = $this->url->link('localisation/tax_rate/delete', 'user_tokens=' . $this->session->data['user_tokens'] . $url);
		...
		foreach ($results as $result) {
			$data['tax_rates'][] = array(
				...
				'edit'          => $this->url->link('localisation/tax_rate/edit', 'user_tokens=' . $this->session->data['user_tokens'] . '&tax_rate_id=' . $result['tax_rate_id'] . $url)
			);
		}
		...
		$data['sort_name'] = $this->url->link('localisation/tax_rate', 'user_tokens=' . $this->session->data['user_tokens'] . '&sort=tr.name' . $url);
		$data['sort_rate'] = $this->url->link('localisation/tax_rate', 'user_tokens=' . $this->session->data['user_tokens'] . '&sort=tr.rate' . $url);
		$data['sort_type'] = $this->url->link('localisation/tax_rate', 'user_tokens=' . $this->session->data['user_tokens'] . '&sort=tr.type' . $url);
		$data['sort_geo_zone'] = $this->url->link('localisation/tax_rate', 'user_tokens=' . $this->session->data['user_tokens'] . '&sort=gz.name' . $url);
		$data['sort_date_added'] = $this->url->link('localisation/tax_rate', 'user_tokens=' . $this->session->data['user_tokens'] . '&sort=tr.date_added' . $url);
		$data['sort_date_modified'] = $this->url->link('localisation/tax_rate', 'user_tokens=' . $this->session->data['user_tokens'] . '&sort=tr.date_modified' . $url);
		...
		$pagination->url = $this->url->link('localisation/tax_rate', 'user_tokens=' . $this->session->data['user_tokens'] . $url . '&page={page}');
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['tax_rate_id'])) {
			$data['action'] = $this->url->link('localisation/tax_rate/add', 'user_tokens=' . $this->session->data['user_tokens'] . $url);
		} else {
			$data['action'] = $this->url->link('localisation/tax_rate/edit', 'user_tokens=' . $this->session->data['user_tokens'] . '&tax_rate_id=' . $this->request->get['tax_rate_id'] . $url);
		}

		$data['cancel'] = $this->url->link('localisation/tax_rate', 'user_tokens=' . $this->session->data['user_tokens'] . $url);
