...
class ControllerLocalisationWeightClass extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('localisation/weight_class', 'user_tokens=' . $this->session->data['user_tokens'] . $url));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('localisation/weight_class', 'user_tokens=' . $this->session->data['user_tokens'] . $url)
		);

		$data['add'] = $this->url->link('localisation/weight_class/add', 'user_tokens=' . $this->session->data['user_tokens'] . $url);
		$data['delete'] = $this->url->link('localisation/weight_class/delete', 'user_tokens=' . $this->session->data['user_tokens'] . $url);
		...
		foreach ($results as $result) {
			$data['weight_classes'][] = array(
				...
				'unit'            => $result['unit'],
				'value'           => $result['value'],
				'edit'            => $this->url->link('localisation/weight_class/edit', 'user_tokens=' . $this->session->data['user_tokens'] . '&weight_class_id=' . $result['weight_class_id'] . $url)
			);
		}
		...
		$data['sort_title'] = $this->url->link('localisation/weight_class', 'user_tokens=' . $this->session->data['user_tokens'] . '&sort=title' . $url);
		$data['sort_unit'] = $this->url->link('localisation/weight_class', 'user_tokens=' . $this->session->data['user_tokens'] . '&sort=unit' . $url);
		$data['sort_value'] = $this->url->link('localisation/weight_class', 'user_tokens=' . $this->session->data['user_tokens'] . '&sort=value' . $url);
		...
		$pagination->url = $this->url->link('localisation/weight_class', 'user_tokens=' . $this->session->data['user_tokens'] . $url . '&page={page}');
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['weight_class_id'])) {
			$data['action'] = $this->url->link('localisation/weight_class/add', 'user_tokens=' . $this->session->data['user_tokens'] . $url);
		} else {
			$data['action'] = $this->url->link('localisation/weight_class/edit', 'user_tokens=' . $this->session->data['user_tokens'] . '&weight_class_id=' . $this->request->get['weight_class_id'] . $url);
		}

		$data['cancel'] = $this->url->link('localisation/weight_class', 'user_tokens=' . $this->session->data['user_tokens'] . $url);
