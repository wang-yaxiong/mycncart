...
class ControllerCatalogInformation extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('catalog/information', 'user_tokens=' . $this->session->data['user_tokens'] . $url));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('catalog/information', 'user_tokens=' . $this->session->data['user_tokens'] . $url)
		);

		$data['add'] = $this->url->link('catalog/information/add', 'user_tokens=' . $this->session->data['user_tokens'] . $url);
		$data['delete'] = $this->url->link('catalog/information/delete', 'user_tokens=' . $this->session->data['user_tokens'] . $url);
		...
		foreach ($results as $result) {
			$data['informations'][] = array(
				...
				'edit'           => $this->url->link('catalog/information/edit', 'user_tokens=' . $this->session->data['user_tokens'] . '&information_id=' . $result['information_id'] . $url)
			);
		}
		...
		$data['sort_title'] = $this->url->link('catalog/information', 'user_tokens=' . $this->session->data['user_tokens'] . '&sort=id.title' . $url);
		$data['sort_sort_order'] = $this->url->link('catalog/information', 'user_tokens=' . $this->session->data['user_tokens'] . '&sort=i.sort_order' . $url);
		...
		$pagination->url = $this->url->link('catalog/information', 'user_tokens=' . $this->session->data['user_tokens'] . $url . '&page={page}');
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['information_id'])) {
			$data['action'] = $this->url->link('catalog/information/add', 'user_tokens=' . $this->session->data['user_tokens'] . $url);
		} else {
			$data['action'] = $this->url->link('catalog/information/edit', 'user_tokens=' . $this->session->data['user_tokens'] . '&information_id=' . $this->request->get['information_id'] . $url);
		}

		$data['cancel'] = $this->url->link('catalog/information', 'user_tokens=' . $this->session->data['user_tokens'] . $url);
