...
class ControllerCatalogManufacturer extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('catalog/manufacturer', 'user_tokens=' . $this->session->data['user_tokens'] . $url));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('catalog/manufacturer', 'user_tokens=' . $this->session->data['user_tokens'] . $url)
		);

		$data['add'] = $this->url->link('catalog/manufacturer/add', 'user_tokens=' . $this->session->data['user_tokens'] . $url);
		$data['delete'] = $this->url->link('catalog/manufacturer/delete', 'user_tokens=' . $this->session->data['user_tokens'] . $url);
		...
		foreach ($results as $result) {
			$data['manufacturers'][] = array(
				...
				'edit'            => $this->url->link('catalog/manufacturer/edit', 'user_tokens=' . $this->session->data['user_tokens'] . '&manufacturer_id=' . $result['manufacturer_id'] . $url)
			);
		}
		...
		$data['sort_name'] = $this->url->link('catalog/manufacturer', 'user_tokens=' . $this->session->data['user_tokens'] . '&sort=name' . $url);
		$data['sort_sort_order'] = $this->url->link('catalog/manufacturer', 'user_tokens=' . $this->session->data['user_tokens'] . '&sort=sort_order' . $url);
		...
		$pagination->url = $this->url->link('catalog/manufacturer', 'user_tokens=' . $this->session->data['user_tokens'] . $url . '&page={page}');
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['manufacturer_id'])) {
			$data['action'] = $this->url->link('catalog/manufacturer/add', 'user_tokens=' . $this->session->data['user_tokens'] . $url);
		} else {
			$data['action'] = $this->url->link('catalog/manufacturer/edit', 'user_tokens=' . $this->session->data['user_tokens'] . '&manufacturer_id=' . $this->request->get['manufacturer_id'] . $url);
		}

		$data['cancel'] = $this->url->link('catalog/manufacturer', 'user_tokens=' . $this->session->data['user_tokens'] . $url);
