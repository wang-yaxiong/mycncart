...
class ControllerExtensionTotalCredit extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/total/credit', 'user_tokens=' . $this->session->data['user_tokens'])
		);

		$data['action'] = $this->url->link('extension/total/credit', 'user_tokens=' . $this->session->data['user_tokens']);
