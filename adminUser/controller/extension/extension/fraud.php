		...
		if ($files) {
			foreach ($files as $file) {
				...
				$data['extensions'][] = array(
					...
					'install'   => $this->url->link('extension/extension/fraud/install', 'user_tokens=' . $this->session->data['user_tokens'] . '&extension=' . $extension),
					'uninstall' => $this->url->link('extension/extension/fraud/uninstall', 'user_tokens=' . $this->session->data['user_tokens'] . '&extension=' . $extension),
					'installed' => in_array($extension, $extensions),
					'edit'      => $this->url->link('extension/fraud/' . $extension, 'user_tokens=' . $this->session->data['user_tokens'])
				);
			}
		}
