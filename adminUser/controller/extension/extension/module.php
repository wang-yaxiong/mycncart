...
class ControllerExtensionExtensionModule extends Controller {
	...
	protected function getList() {
		$data['text_layout'] = sprintf($this->language->get('text_layout'), $this->url->link('design/layout', 'user_tokens=' . $this->session->data['user_tokens']));
			...
			foreach ($files as $file) {
				...
				foreach ($modules as $module) {
					...
					$module_data[] = array(
						...
						'edit'      => $this->url->link('extension/module/' . $extension, 'user_tokens=' . $this->session->data['user_tokens'] . '&module_id=' . $module['module_id']),
						'delete'    => $this->url->link('extension/extension/module/delete', 'user_tokens=' . $this->session->data['user_tokens'] . '&module_id=' . $module['module_id'])
					);
				}
				...
				$data['extensions'][] = array(
					...
					'module'    => $module_data,
					'install'   => $this->url->link('extension/extension/module/install', 'user_tokens=' . $this->session->data['user_tokens'] . '&extension=' . $extension),
					'uninstall' => $this->url->link('extension/extension/module/uninstall', 'user_tokens=' . $this->session->data['user_tokens'] . '&extension=' . $extension),
					'installed' => in_array($extension, $extensions),
					'edit'      => $this->url->link('extension/module/' . $extension, 'user_tokens=' . $this->session->data['user_tokens'])
				);
			}
		}
