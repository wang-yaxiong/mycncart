		...
		if ($files) {
			foreach ($files as $file) {
				...
				$store_data[] = array(
					...
					'edit'   => $this->url->link('extension/analytics/' . $extension, 'user_tokens=' . $this->session->data['user_tokens'] . '&store_id=0'),
				...
				foreach ($stores as $store) {
					$store_data[] = array(
						'name'   => $store['name'],
						'edit'   => $this->url->link('extension/analytics/' . $extension, 'user_tokens=' . $this->session->data['user_tokens'] . '&store_id=' . $store['store_id']),
				...
				$data['extensions'][] = array(
					...
					'install'   => $this->url->link('extension/extension/analytics/install', 'user_tokens=' . $this->session->data['user_tokens'] . '&extension=' . $extension),
					'uninstall' => $this->url->link('extension/extension/analytics/uninstall', 'user_tokens=' . $this->session->data['user_tokens'] . '&extension=' . $extension),
