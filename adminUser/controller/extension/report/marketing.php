...
class ControllerExtensionReportMarketing extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/report/marketing', 'user_tokens=' . $this->session->data['user_tokens'])
		);

		$data['action'] = $this->url->link('extension/report/marketing', 'user_tokens=' . $this->session->data['user_tokens']);
	...
	public function report() {
		...
		foreach ($results as $result) {
			$data['marketings'][] = array(
				...
				'action'   => $this->url->link('marketing/marketing/edit', 'user_tokens=' . $this->session->data['user_tokens'] . '&marketing_id=' . $result['marketing_id'])
			);
		}
		...
		$pagination->url = $this->url->link('report/report', 'user_tokens=' . $this->session->data['user_tokens'] . '&code=marketing' . $url . '&page={page}');
