...
class ControllerExtensionReportCustomerActivity extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/report/customer_activity', 'user_tokens=' . $this->session->data['user_tokens'])
		);

		$data['action'] = $this->url->link('extension/report/customer_activity', 'user_tokens=' . $this->session->data['user_tokens']);
	...
	public function report() {
		...
		foreach ($results as $result) {
			...
			$replace = array(
				$this->url->link('customer/customer/edit', 'user_tokens=' . $this->session->data['user_tokens'] . '&customer_id='),
				$this->url->link('sale/order/info', 'user_tokens=' . $this->session->data['user_tokens'] . '&order_id=')
			);
		...
		$pagination->url = $this->url->link('report/report', 'user_tokens=' . $this->session->data['user_tokens'] . '&code=customer_activity' . $url . '&page={page}');
