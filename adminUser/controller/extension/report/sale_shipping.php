...
class ControllerExtensionReportSaleShipping extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/report/sale_shipping', 'user_tokens=' . $this->session->data['user_tokens'])
		);

		$data['action'] = $this->url->link('extension/report/sale_shipping', 'user_tokens=' . $this->session->data['user_tokens']);
	...
	public function report() {
		...
		$pagination->url = $this->url->link('report/report', 'user_tokens=' . $this->session->data['user_tokens'] . '&code=sale_shipping' . $url . '&page={page}');
