...
class ControllerExtensionReportCustomerTransaction extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/report/customer_transaction', 'user_tokens=' . $this->session->data['user_tokens'])
		);

		$data['action'] = $this->url->link('extension/report/customer_transaction', 'user_tokens=' . $this->session->data['user_tokens']);
	...
	public function report() {
		...
		$pagination->url = $this->url->link('report/report', 'user_tokens=' . $this->session->data['user_tokens'] . '&code=customer_transaction' . $url . '&page={page}');
