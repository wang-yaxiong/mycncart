...
class ControllerExtensionReportProductPurchased extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/report/product_purchased', 'user_tokens=' . $this->session->data['user_tokens'])
		);

		$data['action'] = $this->url->link('extension/report/product_purchased', 'user_tokens=' . $this->session->data['user_tokens']);
	...
	public function report() {
		...
		$pagination->url = $this->url->link('report/report', 'user_tokens=' . $this->session->data['user_tokens'] . '&code=product_purchased' . $url . '&page={page}');
