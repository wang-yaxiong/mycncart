...
class ControllerExtensionFeedGoogleSitemap extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/feed/google_sitemap', 'user_tokens=' . $this->session->data['user_tokens'])
		);

		$data['action'] = $this->url->link('extension/feed/google_sitemap', 'user_tokens=' . $this->session->data['user_tokens']);
