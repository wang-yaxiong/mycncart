...
class ControllerExtensionDashboardActivity extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/dashboard/activity', 'user_tokens=' . $this->session->data['user_tokens'])
		);

		$data['action'] = $this->url->link('extension/dashboard/activity', 'user_tokens=' . $this->session->data['user_tokens']);
	...
	public function dashboard() {
		...
		foreach ($results as $result) {
			...
			$replace = array(
				...
				$this->url->link('sale/return/edit', 'user_tokens=' . $this->session->data['user_tokens'] . '&return_id=')
			);
