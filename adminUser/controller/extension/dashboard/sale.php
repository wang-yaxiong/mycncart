...
class ControllerExtensionDashboardSale extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/dashboard/sale', 'user_tokens=' . $this->session->data['user_tokens'])
		);

		$data['action'] = $this->url->link('extension/dashboard/sale', 'user_tokens=' . $this->session->data['user_tokens']);
	...
	public function dashboard() {
		...
		$data['sale'] = $this->url->link('sale/order', 'user_tokens=' . $this->session->data['user_tokens']);
