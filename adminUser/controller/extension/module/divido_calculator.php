...
class ControllerExtensionModuleDividoCalculator extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/divido_calculator', 'user_tokens=' . $this->session->data['user_tokens'])
		);

		$data['action'] = $this->url->link('extension/module/divido_calculator', 'user_tokens=' . $this->session->data['user_tokens']);
