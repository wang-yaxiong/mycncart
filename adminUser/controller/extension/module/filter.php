...
class ControllerExtensionModulefilter extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/filter', 'user_tokens=' . $this->session->data['user_tokens'])
		);

		$data['action'] = $this->url->link('extension/module/filter', 'user_tokens=' . $this->session->data['user_tokens']);
