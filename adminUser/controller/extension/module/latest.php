	...
	public function index() {
		...
		if (!isset($this->request->get['module_id'])) {
			$data['breadcrumbs'][] = array(
				...
				'href' => $this->url->link('extension/module/latest', 'user_tokens=' . $this->session->data['user_tokens'])
			);
		} else {
			$data['breadcrumbs'][] = array(
				'text' => $this->language->get('heading_title'),
				'href' => $this->url->link('extension/module/latest', 'user_tokens=' . $this->session->data['user_tokens'] . '&module_id=' . $this->request->get['module_id'])
			);
		}

		if (!isset($this->request->get['module_id'])) {
			$data['action'] = $this->url->link('extension/module/latest', 'user_tokens=' . $this->session->data['user_tokens']);
		} else {
			$data['action'] = $this->url->link('extension/module/latest', 'user_tokens=' . $this->session->data['user_tokens'] . '&module_id=' . $this->request->get['module_id']);
		}
