...
class ControllerExtensionModuleLaybuyLayout extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/laybuy_layout', 'user_tokens=' . $this->session->data['user_tokens'])
		);
		...
		$data['action'] = $this->url->link('extension/module/laybuy_layout', 'user_tokens=' . $this->session->data['user_tokens']);
