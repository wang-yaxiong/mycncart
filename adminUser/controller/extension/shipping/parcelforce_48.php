...
class ControllerExtensionShippingParcelforce48 extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/shipping/parcelforce_48', 'user_tokens=' . $this->session->data['user_tokens'])
		);

		$data['action'] = $this->url->link('extension/shipping/parcelforce_48', 'user_tokens=' . $this->session->data['user_tokens']);
