...
class ControllerExtensionFraudIp extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/fraud/ip', 'user_tokens=' . $this->session->data['user_tokens'])
		);

		$data['action'] = $this->url->link('extension/fraud/ip', 'user_tokens=' . $this->session->data['user_tokens']);
    ...
    public function ip() {
		...
		$pagination->limit = 10;
		$pagination->url = $this->url->link('extension/fraud/ip/ip', 'user_tokens=' . $this->session->data['user_tokens'] . '&page={page}');
