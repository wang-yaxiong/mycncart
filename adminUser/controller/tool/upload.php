...
class ControllerToolUpload extends Controller {
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			...
			$this->response->redirect($this->url->link('tool/upload', 'user_tokens=' . $this->session->data['user_tokens'] . $url));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('tool/upload', 'user_tokens=' . $this->session->data['user_tokens'] . $url)
		);

		$data['delete'] = $this->url->link('tool/upload/delete', 'user_tokens=' . $this->session->data['user_tokens'] . $url);
		...
		foreach ($results as $result) {
			$data['uploads'][] = array(
				...
				'download'   => $this->url->link('tool/upload/download', 'user_tokens=' . $this->session->data['user_tokens'] . '&code=' . $result['code'] . $url)
			);
		}
		...
		$data['sort_name'] = $this->url->link('tool/upload', 'user_tokens=' . $this->session->data['user_tokens'] . '&sort=name' . $url);
		$data['sort_filename'] = $this->url->link('tool/upload', 'user_tokens=' . $this->session->data['user_tokens'] . '&sort=filename' . $url);
		$data['sort_date_added'] = $this->url->link('tool/upload', 'user_tokens=' . $this->session->data['user_tokens'] . '&sort=date_added' . $url);
		...
		$pagination->url = $this->url->link('tool/upload', 'user_tokens=' . $this->session->data['user_tokens'] . $url . '&page={page}');
